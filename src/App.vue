...
const goToHome = () => {
  if (isConnected.value) {
    if (!confirm("正在加速中，返回首頁不會斷開連線，確定返回嗎？")) return;
  }
...
<template>
  <div
    class="h-screen w-full bg-zinc-950 text-white flex overflow-hidden font-sans"
  >
    <!-- Sidebar -->
    <aside class="w-64 bg-zinc-900 border-r border-zinc-800 flex flex-col">
      <div class="p-6 flex items-center gap-2 cursor-pointer" @click="goToHome">
      ...
      <div class="flex-1 p-8 overflow-auto">
          ...
          <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            >
              ...
              >
                ...
                <CardDescription class="text-zinc-400 flex items-center gap-2">
        ...
        >
          <div class="flex items-start gap-8">
            <!-- Game Cover -->
            <div
              class="w-64 aspect-[3/4] rounded-lg overflow-hidden shadow-2xl border border-zinc-800 relative"
            >
              <img
            ...
            <div class="flex-1 space-y-6">
              <div>
                <h1 class="text-4xl font-bold mb-2">{{ selectedGame.name }}</h1>
                <p class="text-zinc-400">請選擇加速節點並啟動服務</p>
              </div>

              <div class="grid grid-cols-1 gap-4">
                <div
                  class="bg-zinc-900 p-4 rounded-lg border border-zinc-800 space-y-2"
                >
                  <label
                ...
                <div
                  v-if="selectedServer"
                  class="bg-zinc-900 rounded-lg border border-zinc-800 overflow-hidden relative h-80"
                >
                  <ServerGlobe
                    :markers="[
              ...
              <div
                class="pt-4 border-t border-zinc-800 sticky bottom-0 bg-zinc-950 py-4"
              >
                <Button
                  v-if="!isConnected"
                  @click="handleConnect"
